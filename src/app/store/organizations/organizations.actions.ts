...
export const loadOrganizations = createAction(
  `${key} Load Organizations`,
  props<{ filter: OrganizationListFilter }>(),
);
export const loadOrganizationsSuccess = createAction(
  `${key} Load Organizations Success`,
  props<{ response: PaginatedResponse<OrganizationListItemModel> }>(),
);
...
export const loadOrganizationSuccess = createAction(
  `${key} Load Organization Success`,
  props<{ item: OrganizationModel }>(),
);
...
export const createOrganization = createAction(
  ...
  props<{ command: CreateOrganizationCommand }>(),
);
export const createOrganizationSuccess = createAction(
  `${key} Create Organization Success`,
  props<{ id: string }>(),
);
...
export const updateOrganization = createAction(
  ...
  props<{ command: UpdateOrganizationCommand }>(),
);
...
export const deleteOrganizationSuccess = createAction(
  `${key} Delete Organization Success`,
  props<{ id: string }>(),
);
