...
export const loadProjectsSuccess = createAction(
  `${key} Load Success`,
  props<{ response: PaginatedResponse<WorkProjectItemModel> }>(),
);
...
export const loadProjectSuccess = createAction(
  `${key} Load One Success`,
  props<{ item: WorkProjectModel }>(),
);
...
export const createProject = createAction(
  `${key} Create`,
  props<{ command: CreateWorkProjectCommand }>(),
);
...
export const updateProject = createAction(
  `${key} Update`,
  props<{ command: UpdateWorkProjectCommand }>(),
);
...
export const updateProjectStatus = createAction(
  `${key} Update Status`,
  props<{ id: string; projectStatusId: number }>(),
);

export const updateProjectStatusSuccess = createAction(
  `${key} Update Status Success`,
  props<{ id: string; projectStatusId: number }>(),
);
...
export const addProjectParticipantSuccess = createAction(
  `${key} Add Participant Success`,
  props<{ id: string }>(),
);
...
export const updateProjectParticipantSuccess = createAction(
  `${key} Update Participant Success`,
  props<{ id: string }>(),
);
...
export const deleteProjectParticipantSuccess = createAction(
  `${key} Delete Participant Success`,
  props<{ id: string }>(),
);
